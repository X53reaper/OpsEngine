...
# Trigger a test webhook to run the agent
print("=== TRIGGER TEST WEBHOOK ===")
import json
...
p.query('SELECT agent_name,trigger_type,status,cost_usd,model_used,started_at,completed_at FROM agent_run_log ORDER BY started_at DESC LIMIT 5')
