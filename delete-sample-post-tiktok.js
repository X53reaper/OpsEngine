// Script to delete the TikTok sample post from Buffer
// Location: delete-sample-post-tiktok.js
...
async function deletePost(postId) {
  ...
  console.log('Deleting TikTok post:', postId);
  ...
  try {
    ...
    if (payload?.__typename === 'PostActionSuccess') {
      console.log('\nSUCCESS! TikTok post deleted from Buffer queue.');
    } else {
...
const postIdFile = path.join(__dirname, 'last-tiktok-post-id.txt');
let postId = '6a375b9f8f0197acb5d55e5c'; // Default to the one we just created
